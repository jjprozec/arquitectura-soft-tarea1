...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { body: @curso.body, name: @curso.name, sigla: @curso.sigla } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { body: @curso.body, name: @curso.name, sigla: @curso.sigla } }
